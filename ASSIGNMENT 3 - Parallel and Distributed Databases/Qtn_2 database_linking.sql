...
-- Selecting departments at the Kigali Branch database
SELECT * FROM Department_Kigali@KIGALI_BRANCH_LINK;

-- selecting all doctors at the Kigali_Branch database tabled named Doctor_Kigali
select * from Doctor_Kigali@KIGALI_BRANCH_LINK;

-- Inserting one doctor to doctor table at Kigali_Branch
INSERT INTO Doctor_Kigali@KIGALI_BRANCH_LINK (doctorid, fullname,specialty,deptid,phone,email) 
VALUES(10,'Aaron Phiri','Gynecologist','2',0798789809,'aaronphiri@gmail.com');
